        ...
        <div class="row">
            <div class="col-md-5 seccion1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="card-header">Ingrese CI:</h6>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h6 class="card-header">Ingrese Código:</h6>
                        <form action="Controlador?menu=Ventas" method="post">
                            <div class="row">
                                <div class="col-md-8 d-flex form-group">
                                    <input type="number" name="codigoproducto" class="form-control" placeholder="Código Producto" value="${productoseleccionado.getCodigo()}">
                    ...
                    <tbody>
                       ...
                       <c:forEach var="lista" items="${listaventas}">
                        <tr>
                            ...
                            <!-- JOS Para colocar el tipo de Moneda: -->
                            <td>Bs ${lista.getPrecio()}</td>
                            <td style="width: 30px;">${lista.getCantidad()}</td>
                            <td>Bs ${lista.getSubtotal()}</td>
                            <td class="columna">
